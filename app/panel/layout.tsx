...
const navItems = [
  ...
  { href: "/panel/pacientes/nuevo", label: "Nuevo paciente", icon: "+" },
];
        ...
        <div className="grid gap-5 lg:grid-cols-[260px_1fr]">
          <aside className="h-fit rounded-3xl border border-[var(--border)] bg-white/95 p-5 shadow-[0_14px_38px_rgba(37,99,235,0.12)] lg:sticky lg:top-6">
            <div>
              ...
              <p className="text-xs text-slate-500">Panel del psicologo</p>
            </div>
            ...
            <div className="mt-4 rounded-2xl border border-[var(--border)] bg-[var(--surface-soft)] p-3">
              <div className="flex items-center gap-3">
                <ProfileAvatar
                  ...
                  alt="Perfil psicologo"
                  className="h-10 w-10 rounded-full border border-blue-100 object-cover"
                />
                <div>
                  <p className="text-xs font-semibold text-slate-800">Dra. Sofia Martin</p>
                  <p className="text-[11px] text-slate-500">Psicologa clinica</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between border-b border-[var(--border)] px-5 py-4 sm:px-6">
              <div>
                ...
                <p className="text-xs text-slate-500">
                  Psicologo - Terapia entre sesiones
                </p>
              </div>

...
const navItems = [
  { href: "/panel-demo", label: "Dashboard", icon: "DB" },
  { href: "/panel-demo/pacientes", label: "Pacientes", icon: "PA" },
  { href: "/panel-demo/informes", label: "Informes", icon: "IN" },
  { href: "/panel-demo/tareas", label: "Tareas", icon: "TA" },
  { href: "/panel-demo/pacientes/nuevo", label: "Añadir paciente", icon: "+" },
];

export default function PanelDemoLayout({
  children,
}: {
        ...
        <div className="grid gap-5 lg:grid-cols-[270px_1fr]">
          <aside className="h-fit rounded-[28px] border border-[#d7deea] bg-white p-5 shadow-[0_6px_24px_rgba(15,23,42,0.05)] lg:sticky lg:top-6">
            <div>
              ...
              <p className="text-xs text-[#6a7f9a]">Demo comercial</p>
            </div>
          ...
          <main className="rounded-[30px] border border-[#d7deea] bg-white shadow-[0_6px_24px_rgba(15,23,42,0.05)]">
            <div className="flex items-center justify-between border-b border-[#dbe2ed] px-5 py-4 sm:px-6">
              <div>
                ...
                <p className="text-xs text-[#617896]">Psicólogo - Entorno demo</p>
              </div>
